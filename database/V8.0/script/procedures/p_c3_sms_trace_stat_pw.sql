DELIMITER  ;
DROP PROCEDURE IF EXISTS p_c3_sms_trace_stat_pw;

DELIMITER //
CREATE PROCEDURE p_c3_sms_trace_stat_pw(IN p_bureau_code      VARCHAR(60)
...
BEGIN
    ...
    SET v_filter = concat(v_filter, char(10), if(p_p_org_code IS NOT NULL, concat("and org_code = '", p_p_org_code, "'"), v_space));
    ...
    ALTER TABLE wv_agg_sms_alarm
        MODIFY routing_no VARCHAR(40);
    ALTER TABLE wv_agg_sms_alarm
        MODIFY line_code VARCHAR(40);
