...
(
    ...
    `faultalarmcntoflv1`     int(11),
    `faultalarmcntoflv2`     int(11),
    `faultalarmcntoflv3`     int(11),
    `faultalarmcntoflv1_out` int(11),
    `faultalarmcntoflv2_out` int(11),
    `faultalarmcntoflv3_out` int(11),
    `begin_time`             datetime,
    `end_time`               datetime,
