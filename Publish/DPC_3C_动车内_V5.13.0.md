...
SPRINT2:2020/01/17-2020/01/17 补丁版本修复
...
-|-|-|-|-
 ...
 动车对内数据终端网站| DPC_3C_I_V5.13.1 |2020/01/17| 有 |补丁版本，修复周报导出
 ...
 AI智能机WebAPI| AiWebAPI_V2.1 |2020/01/16| 有 | 修复AI识别结果对打弓等高危报警覆盖问题
 3C解析监控服务| 3CMonoitor_3.2.0|2019/12/24| 有 |增加raisetime报警文件时间
 云转发服务| 3CDataTransmitterBroker_V1.5.0 |2019/12/13| 无 |

动车对内数据终端网站 - DPC_3C_I_V5.13.0 ~ V5.13.1
-----------------------------------

1. 版本号
DPC_3C_I_V5.13.0 ~ 13.1
2. 更新内容
    1. AI API地址可配置
    2. 报警性能监控图表优化
    3. 增加3C服务监控页面
