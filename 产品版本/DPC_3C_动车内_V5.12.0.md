...
减少文件存储实现实时提图；去掉共享文件、AI业务耦合实现AI接口消息消费和更新业务数据(已变更)  
1. 2019/12/10 AI部分下个版本发布
...
-|-|-|-|-
 ...
 AI消息消费服务|AI_MQConsumerService_V2.0|2019/12/13| 无（变更） |大数据不再操作更新Alarm，由3C调用大数据接口实现
 AI智能机WebAPI| AiWebAPI_V2.0 |2019/12/13| 无（变更） |大数据不再操作更新Alarm，由3C调用大数据接口实现
